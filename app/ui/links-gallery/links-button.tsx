...
export default function LinksButton( { name, imageSrc, url } : Link ) {
    return (
        <a className="border-2 border-slate-500 rounded-xl flex flex-col w-64 min-h-64 sm:min-h-48 sm:w-48 m-4 md:m-4 hover:brightness-50 hover:drop-shadow-lg" href={url} target="_blank">
